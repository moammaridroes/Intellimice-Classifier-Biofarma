...
<head>
  ...
  <style>
    .status-approved {
      background-color: #d4edda; /* Hijau muda untuk approved */
      color: #155724;
      border-left: 5px solid #28a745;
    }

    .status-rejected {
      background-color: #f8d7da; /* Merah muda untuk rejected */
      color: #721c24;
      border-left: 5px solid #dc3545;
    }

    .status-pending {
      background-color: #fff3cd; /* Kuning muda untuk pending */
      color: #856404;
                                    ...
                                    <div class="card-body">
                                        <div class="notification-info">
                                            ...
                                            <p>
                                                ...
                                                Pesanan Anda telah ditolak. Mohon hubungi admin untuk informasi lebih lanjut.
                                                @else
