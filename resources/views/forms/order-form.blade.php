              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">Name of item ordered</label>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Fill in required amount of order</label>
                    <input type="text" class="form-control form-control-lg" placeholder="Weight Ordered" aria-label="Username">
                  </div>
                </div>
              </div>
            </div>
